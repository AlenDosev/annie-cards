...
export default {
  ...
  async mounted() {
    ...
    const { data } = await this.axios.get(
      "https://sheets.googleapis.com/v4/spreadsheets/1EHBijDmk5nIANiYF4aiUViKKNPfKfgdw-Ws4B8Xt5mA/values/Annie!A1:B100?key=AIzaSyDXokXhuuI6PRqUDAMw1dDhOKXlFHcWDh0"
    );
